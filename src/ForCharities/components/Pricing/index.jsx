        ...
        <div className="pricing-main-wrapper">
          ...
          <div className="pricing-tier-wrapper">
            ...
            <div className="pricing-features">  
              ...
              <PricingFeature uniqueID="eliminate" text="Negotiable Service Fees" tooltipText="We cater for organisations of all size.  If your organisation is expecting significant volume, we can talk about custom upfront packages to do away with our fee altogether."/>
