			...
			<div className="partners-page">
				<div className="partners">
					...
					<div className="content">
						...
						<p>StreetChange is dedicated to continuing to maximise impact by partnering with other like organisations across the UK. We urge you to <a href="http://givingweb.local/contact-us/">contact us</a> if you are interested in becoming a StreetChange partner. Our purpose is to serve as a tool that allows grassroots organisations to reach new audiences, tap in local community crowdfunding, and financially empower their beneficiaries. So if you think you could benefit from our services, <a href="http://givingweb.local/contact-us/"> get in touch TODAY</a>!</p>
					</div>
				</div>
			</div>
		)
