...
import css from './TermsAndPrivacy.scss'
...
class TermsAndPrivacy extends React.Component {
	...
	render() {
      ...
      <main className="full-width centre">
        ...
        <p>StreetChange operates www.streetchange.org.uk (the “Website”) and its associated services. These core terms of govern your use of the Website and its associated services. Please read these Terms of Service carefully. If you do not wish to be bound by these Terms of Service, you should not continue to use or access the Website or its associated services.</p>
